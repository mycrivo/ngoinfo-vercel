...
const clientSchema = z.object({
  NEXT_PUBLIC_API_BASE_URL: z.string().url().default("https://reqagent-dev.railway.app"),
 ...
 * Throws in development if critical variables are missing
 * Logs warnings in production and uses defaults
 */
